	...
	render() {
		...
		if(fbimodal) {
				...
				<div className="Home">
					...
					<div className="content-container">
						...
						<div className="filter">
							...
							<Button id="modal-popup"inverted color='grey' onClick={this.openInsertionModal}> Report Crime </Button>
						</div>
						<div className="modal-div">
							<Modal open={this.state.insertionModalOpen} onClose={this.cancelInsertModal}>
								<Header content={"Report a Crime"} />
								<Modal.Content>
									<div id="scroll-view">
										<h3>Case Number</h3>
			...
			return (
				<div className="Home">
					<div className="navbar" id="nav">
						<Button id="popup-button"> Chicago Crime Tracker </Button>
					</div>
					<div className="content-container">
						<div className="search">
							<Input focus fluid placeholder="Search" value={this.state.search_query} onChange={this.handleChange}/>
