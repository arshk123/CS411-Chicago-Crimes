...
module.exports = function(router) {
  ...
  router.route('/crimes').get(function(req, res) {
   ...
   if(req.query['description']!=null){
     ...
     our_query+=`description LIKE \'\%${req.query.dexcription}\%\'`
   }
   ...
   if(req.query['block']!=null){
     if(our_query!=''){
       our_query += ' AND '
     }
     our_query+='block LIKE \'\%${req.query.block}\%\''
